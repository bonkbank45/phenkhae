...
import { useCourseCompletionStatistics } from '../../hooks/api/useStatisticData';
...
const CourseCompletedPerYear = () => {
  const { data, isLoading } = useCourseCompletionStatistics();
      ...
      <div className="bg-white rounded-lg p-6 shadow-lg dark:bg-slate-800">
        <div className="text-center p-8">
          ...
          <p className="text-lg text-gray-600 font-notoLoopThaiRegular">
            ไม่มีข้อมูลสถิติผู้จบหลักสูตรในระบบ
          </p>
        </div>
      </div>
    );
...
export default CourseCompletedPerYear;
