...
class StoreStudentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            "email" => "nullable|string|max:255|email|unique:students,email",
            "occupation_id" => "required|exists:occupations,id",
            "medical_condition" => "nullable|string|max:60",
    ...
    public function prepareForValidation()
    {
        $this->merge([
            ...
            'learn_massage_description' => $this->learn_massage_description,
            'work_massage' => $this->work_massage === 'ไม่เคยทำงานเกี่ยวข้องกับการนวดไทย' ? 0 : 1,
            'work_massage_description' => $this->work_massage_description,
            'medical_condition' => $this->medical_condition === null ? null : $this->medical_condition,
            'surgery_history' => $this->surgery_history === null ? null : $this->surgery_history,
