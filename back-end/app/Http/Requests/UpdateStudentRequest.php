...
class UpdateStudentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            "email" => "nullable|string|max:255|email|exists:students,email",
    ...
    public function prepareForValidation()
    {
        $this->merge([
            ...
            'medical_condition' => $this->medical_condition === null || $this->medical_condition === 'null' ? null : $this->medical_condition,
