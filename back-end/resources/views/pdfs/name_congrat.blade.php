...
for ($page = 0; $page < $pages; $page++) {
    if ($page > 0) {
        ...
        <div class="header">
            <h1>รายชื่อ<span
                    style="color: blue">ผู้สำเร็จการศึกษา</span>หรือสำเร็จการฝึกอบรมและมีคุณสมบัตรครบถ้วนตามหลักสูตรแต่ละด้านจากสถาบันหรือสถานพยาบาล
            </h1>
            ...
            <div class="header-right">
                ...
                <p style="color: blue">รายชื่อผู้ที่สำเร็จการศึกษา สาขา{{ $courseMap[$students[0]['course_id']][1] }}</p>
            </div>
        </div>
        <table>
            <tr>
