...
<html lang="en">
    <head>
        ...
        <title>
            Certificate หลักสูตรการดูแลสุขภาพและความงามสตรีหลังเรือนไฟ 150
            ชั่วโมง
        </title>
        <style>
            @page {
        ...
        <div class="content">
            <div class="content_m">
                <div class="content_in_pic">
                    ...
                    <p style="text-align: center; font-size: 24pt; margin-top: 1mm">
                    ...
                    <h2
                        ...
                        "
                    >
                        หลักสูตรการดูแลสุขภาพและความงามสตรีหลังเรือนไฟ 150
                        ชั่วโมง
                    </h2>
                    <p
                        style="
                    ...
                    >
                        <b
                            >ระหว่างวันที่ {{ formatDateCertificate($courseCompletion->date_start) }} ถึงวันที่ {{ formatDateCertificate($courseCompletion->date_end) }}</b
                        >
                    </p>
                    <p
                        style="
