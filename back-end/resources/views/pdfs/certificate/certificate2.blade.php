...
<html lang="en">
    <head>
        ...
        <title>Certificate นวดฝ่าเท้า 60 ชั่วโมง</title>
        <style>
            @page {
                margin: 8.5mm;
            }
            ...
            <div class="content_m">
                <div class="content_in_pic">
                    <div class="header">
                        ...
                        <div style="margin-top: 14.2mm; text-align: center">
                            <img
                                src="{{
                    ...
                    <h1 style="margin-top: 3mm">โรงเรียนเพ็ญแขแพทย์แผนไทย</h1>
                    ...
                    <h2
                        ...
                        "
                    >
                        ได้สำเร็จหลักสูตรนวดฝ่าเท้าเพื่อสุขภาพ 60 ชั่วโมง
                    </h2>
                    <p
                        style="
                            text-align: center;
                    ...
                    >
                        <b
                            >ระหว่างวันที่
                            {{ formatDateCertificate($courseCompletion->date_start) }}
                            ถึงวันที่
                            {{ formatDateCertificate($courseCompletion->date_end) }}</b
                        >
                    </p>
                    <p
                        style="
                    ...
                    >
                        <b
                            >ให้ไว้ ณ วันที่
                            {{ formatDateCertificate($courseCompletion->completion_date) }}</b
                        >
                    </p>
                    <p
                        style="
                ...
                <div class="content_in">
                    ...
                    >
                        ...
                        >
                            <b
                                >วันที่
                                {{ formatDateBackOfPageCertificate($courseCompletion->completion_date) }}</b
                            >
                        </p>
                    </div>
                </div>
