...
$data = [
    ["course_name" =>
        "การนวดไทยเพื่อสุขภาพ 150 ชม.", "cost" => "9,000"], ["course_name" =>
        "การนวดฝ่าเท้าเพื่อสุขภาพ 60 ชม.", "cost" => "4,000"], ["course_name" =>
        "การดูแลสตรีหลังเรือนไฟ 150 ชม.", "cost" => "9,500"], ["course_name" =>
        "การนวดด้วยน้ำมันหอมระเหย 150 ชม.", "cost" => "9,500"], ["course_name"
        => "การนวดไสวีดิช 150 ชม.", "cost" => "10,000"], ["course_name" =>
        "การนวดไทย 330 ชม.(ผู้ช่วยแพทย์แผนไทย)", "cost" => "9,500"],
        ...
        <div class="content">
            ...
            <h2>
                17/86 ม.6 ซอย 6/3 ต.คลองสาม อ.คลองหลวง จ.ปทุมธานี<br />โทร.
                02-9011144, 081-6185658, 081-3339430
            </h2>
            <h1><u>ใบรับเงิน</u></h1>
            ...
            <div style="width: 100%">
                ...
                <div style="width: 49.5%; float: right; text-align: right">
                    <p style="margin-right: 3em">
                        {{ number_format($row->course_price) }} บาท
                    </p>
                </div>
